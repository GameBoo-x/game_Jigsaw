...
function addCoins(reward) {
    ...
    const userBalanceElement = document.getElementById('balanceAmount');   if (userBalanceElement) {
...
.then(tasks => {
    ...
    tasks.forEach(task => {
        ...
        button.textContent = taskProgress >= 2 ? 'Completed' : taskProgress === 1 ? 'Claim' : 'Go';
